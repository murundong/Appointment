...
namespace AppointMvc.Web.Controllers
{
    public class AppointController : ControllerBase
    {
        ...
        public ActionResult GetUserCanUseDoorCards(int? doorId, int? uid)
        {
        ...
        public ActionResult AppointCourse(View_AppointCourseInput input)
        {
        ...
        public ActionResult QueueAppointCourse(View_AppointCourseInput input)
        {
        ...
        public ActionResult GetMyAppointComp(View_MyAppointWaitInput input)
        {
            if (input?.uid <= 0) return ReturnJsonResult("参数错误！", Enum_ReturnRes.Fail);
        ...
        public ActionResult GetJudgeCourseInfo(int? cid)
        {
        ...
        public ActionResult JudgeCourse(DoorUsersCourseComments input)
        {
        ...
        public ActionResult QrCode(int? cid)
        {
        ...
        public ActionResult GetSignCourse(int? cid)
        {
        ...
        public ActionResult SignAppointCourse(View_AppointCourseInput input)
        {
            if (input.course_id <= 0 || input.uid <= 0) return ReturnJsonResult("预约失败！参数错误！", Enum_ReturnRes.Fail);
            //校验课程
            Enum_AppointStatus status = _doorUserAppointService.GetCourseAppointStatus(input.uid, input.course_id);
